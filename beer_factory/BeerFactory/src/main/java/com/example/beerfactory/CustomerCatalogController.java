...
public class CustomerCatalogController implements Initializable {
    ...
    void initialize() {
        ...
        ADD.setOnAction(event ->{
            System.out.println(CATALOG.getSelectionModel().getSelectedItem().getBeer_id().toString());
            System.out.println(AMOUNT.getText());
            System.out.println(BOTTLE.getSelectionModel().getSelectedItem().toString());
            DataBaseHandler dataBaseHandler = new DataBaseHandler();
            try {
                Handler handler = new Handler();

                    dataBaseHandler.insertItemIntoCompound(dataBaseHandler.getBottleId(BOTTLE.getSelectionModel().getSelectedItem().toString()), Integer.valueOf(CATALOG.getSelectionModel().getSelectedItem().getBeer_id().toString()),Integer.valueOf(AMOUNT.getText()));
...
//                    AMOUNT.setPromptText("Ошибка!");
                ...
                //dataBaseHandler.insertBeerBottle(dataBaseHandler.getBottleId(BOTTLE.getSelectionModel().getSelectedItem().toString()), Integer.valueOf(CATALOG.getSelectionModel().getSelectedItem().getBeer_id().toString()));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            set = null;
            set = dataBaseHandler.getBottles();
            while(set.next())
            {
                String tmp = set.getString("name");
                BOTTLE.getItems().add(tmp);
            }
